...
export const GameGrid = () => {
	...
	useEffect(() => {
		...
		const { layout, deck: newDeck } = updateDeckAndLayoutOnShowCountChange(
			[...deck],
			[...currentLayout],
			showCount
		);
	...
	useEffect(() => {
		// ASK PLAYER COUNT
		// CALL SERVER TO INIT A NEW GAME
		// SEND AN INVITE CODE FOR THE ROOM SUCH AS THE ROOM ID IS A PATH
